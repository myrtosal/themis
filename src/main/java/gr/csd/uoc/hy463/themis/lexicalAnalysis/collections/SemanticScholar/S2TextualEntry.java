...
public class S2TextualEntry {
    ...
    public String toString() {
        ...
        if (__TITLE__ != null) {
            sb.append(__TITLE__).append("\n");
        }
        if (__ABSTRACT__ != null) {
            sb.append(__ABSTRACT__).append("\n");
        }
        ...
        if (__JOURNAL_NAME__ != null) {
            sb.append(__JOURNAL_NAME__).append("\n");
        }
        if (__VENUE__ != null) {
            sb.append(__VENUE__).append("\n");
        }
        if (__SOURCES__ != null) {
            boolean first = true;
    ...
    public String getUtileInformation() {
    	StringBuilder sb = new StringBuilder();
        if (__TITLE__ != null) {
            sb.append(__TITLE__).append("\n");
        }
