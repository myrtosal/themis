...
/**
 * Implementation of query expansion using Glove file
 *
 * @author Panagiotis Papadakos (papadako@ics.forth.gr)
 */
public class GloveExpansion {
	Config __CONFIG__ ;
	File gloveModel; 
	
	
	public GloveExpansion(Config config) {
		__CONFIG__ = config;
	...
	public static void main(String[] args) throws Exception {
		GloveExpansion glove = new GloveExpansion(new Config()); 
