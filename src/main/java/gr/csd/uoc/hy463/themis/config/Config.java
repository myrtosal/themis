...
public class Config {
    ...
    /**
     * Returns the filename of page rank scores, holding the page rank score for each document
     *
     * @return
     */
    public String getPageRankScoreFile() {
        return __PROP__.getProperty("PAGE_RANK_SCORES");
    }
