...
public abstract class ARetrievalModel {
     ...
     * @throws IOException 
     */
    public abstract List<?> getRankedResults(List<QueryTerm> query, RESULT_TYPE type) throws IOException;
     ...
     * @throws IOException 
     */
    public abstract List<?> getRankedResults(List<QueryTerm> query, RESULT_TYPE type, int topk) throws IOException;
